            ...
            <div class="rp-content">
                <div class="row">
                            ...
                            <div class="booking-form">
                                <form action="{{ route('user.filterDataRoom') }}" method="GET">
                                    <div class="r-filter-time r-people fix-top">
                                        ...
                                        <div class="r-child r-people r-content-5 select-option">
                    ...
                    <div class="col-9">
                        ...
                        <div class="pagination-page fix-top">{!! $paginate->appends([ 'place' => $place, 'checkin' => $checkin, 'checkout' => $checkout, 'adult' => $adult, 'child' => $child,'wifi' => $wifi, 'smoke' => $smoke, 'tivi' => $tivi, 'air' => $air, 'phone' => $phone, 'price' => $price, 'bed' => $bed, 'hotel' => $id])->links() !!}</div>
                    </div>
                </div>
            </div>
        </div>
