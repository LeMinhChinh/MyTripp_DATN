    ...
    <div class="hotel-filter-content">
        <div class="booking-form">
            <form action="#">
                ...
                <div class="r-filter-convenients r-people fix-top">
                    ...
                    <div class="r-prices-content r-content-4">
                        <div class="r-filter-convenient">
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></label>
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="r-filter-convenients r-people">
                    ...
                    <div class="r-prices-content r-content-1">
                        <div class="r-filter-convenient">
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Tuyệt vời : 9.5 điểm trở lên</label>
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Rất tốt : 8.5 điểm trở lên</label>
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Tốt : 8 điểm trở lên</label>
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Hài lòng : 7 điểm trở lên</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <button type="submit" class="filter-submit-rp">Tìm kiếm</button>
            </form>
        </div>
    </div>
</div>
