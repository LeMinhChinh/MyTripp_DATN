@extends('user/index')
@section('title', "Search resting place")

@section('content')
<main class="hotel-main">
    <div class="container">
        <div class="rp-title">
            <a href="">Trang chủ</a><span>></span><a href="">Khách sạn</a><span>></span><a href="" class="main-active">Hà Nội</a>
        </div>
        <hr>
            ...
            <div class="row">
                ...
                <div class="col-9">
                   <div class="list-hotel">
                    <p class="hotel-notification">Hãy lựa chọn cho mình nơi ở tốt nhất <span class="main-active">tại Hà Nội</span></p>
                       <div class="list-hotel-item">
                            <div class="rp-result-item" data-toggle="modal" data-target="#detailRoom">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="rp-item-img">
                                            <img src="../user/img/146006268.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="rp-item-infor">
                                            <div class="rp-name">
                                                <p><small>Khách sạn </small><a href="">Fusion Suites Saigon</a> <span><i class="fa fa-star"></i></span><span><i class="fa fa-star"></i></span><span><i class="fa fa-star"></i></span><span><i class="fa fa-star"></i></span><span><i class="fa fa-star"></i></span></p>
                                            </div>
                                            <div class="rp-map">
